function [] = dataio_create_mat_SSVEP_OV_legacy(folder)
%DATAIO_CREAT_MAT_SSVEP_OV_legacy convert CSV datafiles recorded using
% OpenVibe (< 2.0.0) to a mat file.
% old version (OpenVibe < 2.0.0) save each stream in a single file i.e. raw
% eeg signal and channels in a separate CSV file than stimulation.
%
